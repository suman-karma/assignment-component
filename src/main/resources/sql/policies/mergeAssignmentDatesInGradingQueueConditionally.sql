...
WHEN MATCHED THEN
    UPDATE SET START_DATE=NVL(TO_DATE(:startDate,'YYYY-MM-DD HH24:MI:SS'),START_DATE), DUE_DATE=TO_DATE(:dueDate,'YYYY-MM-DD HH24:MI:SS'),
	FORCE_GRADE_STATUS='NotStarted',UPDATED_DATE=sysdate where  assignment_id=:assignmentId and section_id=:sectionId
